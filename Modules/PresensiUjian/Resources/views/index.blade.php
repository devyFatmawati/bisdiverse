                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100">
                            ...
                            <form
                                ...
                                action="/presensiujian">
                                <div class="col-12 m-0 mb-1">
                                    <input class="form-control @error('no_rfid') is-invalid @enderror" autofocus
                                        name="no_rfid" type="text" placeholder="Mausukan Nomor Kartu Anda"
                                        required />
                                </div>
                            ...
                            @else
                                <img class="img-fluid" src="../../../app-assets/images/pages/coming-soon.svg"
