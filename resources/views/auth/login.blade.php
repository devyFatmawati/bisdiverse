                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <div class="text-center mt-0">
                                    <img src="../../../favicon.png" height="150" alt="logo">
                                </div>
                                <div class="text-center mt-0 mb-2">
                                    <img src="../../../logo_tulisan.png" height="60" alt="logo">
                                </div>
                                ...
                                <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="email" class="form-control" id="email" tabindex="1" name="email" :value="old('email')" required autofocus />
                                    </div>
